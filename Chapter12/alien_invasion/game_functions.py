...
def check_keydown_events(event, ai_settings, screen, stats, sb,  play_button, ship, aliens, bullets):
    ...
    if event.key == pygame.K_RIGHT or event.key == pygame.K_l:
        ...
        if not stats.game_active:
            reset_game(ai_settings, screen, stats, sb,  play_button, ship,
                   aliens, bullets)
...
def reset_game(ai_settings, screen, stats, sb, play_button, ship, aliens,
               bullets):
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    # Draw the play button if the game is inactivate.
    if not stats.game_active:
